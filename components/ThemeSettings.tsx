...
const themes = [
  { name: "Midnight Oasis", value: "midnight" },
  { name: "Rose Gold", value: "rosegold" },
  { name: "Charcoal Steel", value: "charcoal" },
  { name: "Classic Light", value: "classic" },
];
...
export default function ThemeSettings() {
  ...
  return (
    <div className="relative" ref={popupRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-72 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 p-4 z-50">
